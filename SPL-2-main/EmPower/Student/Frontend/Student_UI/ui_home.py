...
"background-color: rgb(255, 252, 232);")
        ...
        self.mat_option_1_frame.setStyleSheet("border: 2px solid rgb(224, 122, 95) ;\n"
"background-color: rgb(61, 64, 91);\n"
"color: white;\n"
"border-radius: 25px;")
        ...
        self.mat_option_2_frame.setStyleSheet("border: 2px solid rgb(224, 122, 95) ;\n"
"background-color: rgb(61, 64, 91);\n"
"color: white;\n"
"border-radius: 25px;")
        ...
        self.mat_option_3_frame.setStyleSheet("border: 2px solid rgb(224, 122, 95) ;\n"
"background-color: rgb(61, 64, 91);\n"
"color: white;\n"
"border-radius: 25px;")
        ...
        self.mat_option_4_frame.setStyleSheet("border: 2px solid rgb(224, 122, 95) ;\n"
"background-color: rgb(61, 64, 91);\n"
"color: white;\n"
"border-radius: 25px;")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
            ...
            self.lbl_lesson_headline.setText(_translate("MainWindow", "Lesson 1"))
            self.lbl_lesson_sub_heading.setText(_translate("MainWindow", "Name Learning - Module 1"))
            self.lsn_lbl_image.setText(_translate("MainWindow", "Image"))
            self.lsn_lbl_lesson_topic.setText(_translate("MainWindow", "Introduction"))
            self.btn_next_lesson.setShortcut(_translate("MainWindow", "Space"))
            self.lbl_lesson_headline_2.setText(_translate("MainWindow", "Puzzle"))
            self.lbl_lesson_sub_heading_2.setText(_translate("MainWindow", "Lesson Evaluation"))
            self.c_lable.setText(_translate("MainWindow", "Congratulations!!!"))
            self.c_next_quiz_lbl.setText(_translate("MainWindow", "Next Evaluation"))
            self.c_next_quiz.setShortcut(_translate("MainWindow", "Right"))
            self.n_message.setText(_translate("MainWindow", "Congratulations!!!"))
            self.n_proceed_btn.setShortcut(_translate("MainWindow", "Right"))
            self.lbl_lesson_headline_3.setText(_translate("MainWindow", "Word Matching"))
            self.lbl_lesson_sub_heading_3.setText(_translate("MainWindow", "Lesson Evaluation"))
            self.lbl_lesson_headline_4.setText(_translate("MainWindow", "Match the Stream"))
            self.lbl_lesson_sub_heading_4.setText(_translate("MainWindow", "Lesson Evaluation"))
            self.lbl_mcq_heading.setText(_translate("MainWindow", "Multiple Choice"))
            self.lbl_mcq_subheading.setText(_translate("MainWindow", "Set 1"))
            self.lbl_mcq_question.setText(_translate("MainWindow", "Question"))
            self.label_7.setText(_translate("MainWindow", "A"))
            self.btn_mcq_option_1.setText(_translate("MainWindow", "Option 1"))
            self.label_13.setText(_translate("MainWindow", "B"))
            self.btn_mcq_option_2.setText(_translate("MainWindow", "Option 2"))
            self.label_14.setText(_translate("MainWindow", "C"))
            self.btn_mcq_option_3.setText(_translate("MainWindow", "Option 3"))
            self.label_15.setText(_translate("MainWindow", "D"))
            self.btn_mcq_option_4.setText(_translate("MainWindow", "Option 4"))
