...
class Home(QMainWindow):  # Home extends QMainWindow
    ...
    def celebration_page(self):
        ...
        if self.current_window == 'puzzle':
            ...
            self.home.c_lable.setText("Congratulations! You have completed this lesson.")
    ...
    def closeEvent(self, event):
        ...
        reply = QMessageBox.question(self, 'Close Software', 'Do you want to close the software?',
