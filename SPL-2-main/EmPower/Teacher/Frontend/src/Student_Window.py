...
class Student_Window(QWidget):  # Home extends QMainWindow
    ...
    def add_new_row(self):
        ...
        custom_form.setWindowTitle("Add data window")
    ...
    def update_student_info(self):
        ...
        # set window icon and title
        custom_form.setWindowIcon(QIcon("Frontend/Images/primary_logo.png"))
        custom_form.setWindowTitle("Change data window")

        # change the heading and submit button text
        form.lbl_heading.setText("Update candidate information")
        ...
        try:
            ...
            show_warning_message("Updating Student Information", "To update student information first click on a student name from the list")
