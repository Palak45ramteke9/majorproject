...
# Form implementation generated from reading ui file '.\Frontend\PyQt_UI\Student_details.ui'
#
...
"}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\Frontend\\PyQt_UI\\../Images/add_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_add_new_student.setIcon(icon1)
        self.btn_add_new_student.setIconSize(QtCore.QSize(25, 25))
...
"}")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(".\\Frontend\\PyQt_UI\\../Images/edit_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_update_student_info.setIcon(icon2)
        self.btn_update_student_info.setIconSize(QtCore.QSize(20, 25))
...
"}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(".\\Frontend\\PyQt_UI\\../Images/trash_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
