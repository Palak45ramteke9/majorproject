...
"}")
        ...
        self.mid_frame.setMinimumSize(QtCore.QSize(1180, 604))
...
"")
        ...
        self.bottom_frame.setMinimumSize(QtCore.QSize(1180, 71))
...
"border-bottom-right-radius: 20px;")
        ...
        self.btn_add_new_lessons.setMinimumSize(QtCore.QSize(250, 50))
        self.btn_add_new_lessons.setMaximumSize(QtCore.QSize(16777215, 50))
        font = QtGui.QFont()
        font.setFamily("Hind Siliguri Medium")
...
"}")
        ...
        self.btn_add_new_lessons.setIconSize(QtCore.QSize(30, 40))
    ...
    def retranslateUi(self, MainWindow):
            ...
            # Translating Bengali labels and items to English
            self.lbl_headline.setText(_translate("MainWindow", "Curriculum"))
            ...
            self.cmb_category.setItemText(1, _translate("MainWindow", "Noun Learning"))
            self.cmb_category.setItemText(2, _translate("MainWindow", "Verb Learning"))
            self.cmb_category.setItemText(3, _translate("MainWindow", "Association Learning"))
            self.cmb_category.setItemText(4, _translate("MainWindow", "Activity Learning"))
            ...
            self.lbl_image_text.setText(_translate("MainWindow", "Identity"))
