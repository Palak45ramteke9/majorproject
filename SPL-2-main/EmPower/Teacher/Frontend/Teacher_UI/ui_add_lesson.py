...
"background-color: rgb(137, 218, 199);")
    ...
    def retranslateUi(self, Form):
        ...
        self.lbl_heading.setText(_translate("Form", "Add module content"))
        self.lbl_category.setText(_translate("Form", "Category"))
        self.cmb_category.setItemText(0, _translate("Form", "Select the category"))
        self.cmb_category.setItemText(1, _translate("Form", "Learn the name (Noun)"))
        self.cmb_category.setItemText(2, _translate("Form", "Learn (Verb)"))
        self.cmb_category.setItemText(3, _translate("Form", "Association Learning"))
        self.cmb_category.setItemText(4, _translate("Form", "Learning Activity"))
        self.lbl_lesson_id.setText(_translate("Form", "Curriculum"))
        self.edit_lesson_id.setPlaceholderText(_translate("Form", "e.g., 1"))
        self.lbl_lesson_topic.setText(_translate("Form", "Lesson Topic"))
        self.edit_lesson_topic.setPlaceholderText(_translate("Form", "e.g., Mango"))
        self.btn_select_photo.setText(_translate("Form", "Select Image/Video"))
        self.btn_select_photo.setShortcut(_translate("Form", "Return"))
        self.btn_select_audio.setText(_translate("Form", "Select Audio"))
        self.btn_select_audio.setShortcut(_translate("Form", "Return"))
        self.lbl_or.setText(_translate("Form", "Or"))
        self.btn_record_audio.setText(_translate("Form", "Record Audio"))
        self.btn_record_audio.setShortcut(_translate("Form", "Return"))
        self.btn_submit.setText(_translate("Form", "Create Module"))
